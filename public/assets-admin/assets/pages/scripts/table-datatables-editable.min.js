var TableDatatablesEditable = function() {
    var e = function() {
        ...
        function t(e, t) {
            var n = e.fnGetData(t),
                a = $(">td", t);
            a[0].innerHTML = '<input type="text" class="form-control input-small" value="" readonly>', 
            a[1].innerHTML = '<input type="text" class="form-control input-small" value="" readonly>', 
            a[2].innerHTML = '<input type="text" class="form-control input-small" value="' + n[2] + '">',
            a[3].innerHTML = '<select class="form-control" value="' + n[3] + '"><option>active</option><option>inactive</option></select>', 
            a[4].innerHTML = '<input type="text" class="form-control input-small" value="" readonly>', 
            a[5].innerHTML = '<input type="text" class="form-control input-small" value="" readonly>', 
            a[6].innerHTML = '<a class="edit" href="/Products/addgroupProduct">Save</a>', 
            a[7].innerHTML = '<a class="cancel" href="">Cancel</a>'
        }

        function n(e, t) {
            var n = $("input", t);
            e.fnUpdate(n[0].value, t, 0, !1), e.fnUpdate(n[1].value, t, 1, !1), e.fnUpdate(n[2].value, t, 2, !1), e.fnUpdate(n[3].value, t, 3, !1), e.fnUpdate(n[4].value, t, 4, !1), e.fnUpdate(n[5].value, t, 5, !1), e.fnUpdate('<a class="edit" href="">Edit</a>', t, 6, !1), e.fnUpdate('<a class="delete" href="">Delete</a>', t, 7, !1), e.fnDraw()
        }
